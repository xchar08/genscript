...
sudo wget -O /etc/apache2/vhosts.d/00_default_ssl_vhost.conf https://raw.githubusercontent.com/xchar08/genscript/main/assets/00_default_ssl_vhost.conf 
...
sudo wget -O /etc/stunnel/stunnel.conf https://raw.githubusercontent.com/xchar08/genscript/main/assets/stunnel.conf 
...
sudo wget -O /etc/fail2ban/paths-common.conf https://raw.githubusercontent.com/xchar08/genscript/main/assets/paths-common.conf

sudo wget -O /etc/fail2ban/jail.conf https://raw.githubusercontent.com/xchar08/genscript/main/assets/jail.conf 
...
sudo wget -O /etc/sysklog.conf https://raw.githubusercontent.com/xchar08/genscript/main/assets/sysklog.conf  
