...
sudo wget -O /etc/portage/env/debugsyms https://raw.githubusercontent.com/xchar08/genscript/main/assets/debugsyms 
sudo wget -O /etc/portage/env/installsources https://raw.githubusercontent.com/xchar08/genscript/main/assets/installsources 
